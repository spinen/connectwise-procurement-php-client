...
/**
 * RMADisposition Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Spinen\ConnectWise\Clients\Procurement
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RMADisposition implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RMADisposition';
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RMADisposition., must be smaller than or equal to 50.');
        }
