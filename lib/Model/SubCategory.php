 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SubCategory implements ArrayAccess
{
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SubCategory., must be smaller than or equal to 50.');
        }
