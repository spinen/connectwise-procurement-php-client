 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RMAAction implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RMAAction';
    ...
    {
        if ((strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RMAAction., must be smaller than or equal to 50.');
        }
